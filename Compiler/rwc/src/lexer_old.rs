            ...
            match c {
                ...
                '+' => {
                    ...
                    if c2 == '+' {
                        ...
                        tokens.push(Token::create(TokenType::PLUS_EQUAL, self.line_number, self.column_number, "+="));
                        self.column_number += 2;
                        i += 2;
                    } else {
                ...
                '-' => {
                    ...
                    if c2 == '-' {
                        ...
                        tokens.push(Token::create(TokenType::MINUS_EQUAL, self.line_number, self.column_number, "-="));
                        self.column_number += 2;
                        i += 2;
                    } else if c2 == '>' {
                ...
                ':' => {
                    ...
                    if c2 == '=' {
                        tokens.push(Token::create(TokenType::COLON_EQUAL, self.line_number, self.column_number, ":="));
                        self.column_number += 2;
                        i += 2;
                    } else if c2 == ':' {
